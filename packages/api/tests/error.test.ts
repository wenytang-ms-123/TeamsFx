...
describe("error", function () {
  describe("UserError", function () {
    it("constructor 1", () => {
      {
        const error = new UserError(mySource, myMessage, myName, myHelpLink);
    ...
    it("constructor 2", () => {
      {
        const error = new UserError(new RangeError(myMessage), mySource);
      ...
      {
        const error = new UserError(new RangeError(myMessage), mySource, myName);
        chai.assert.equal(error.name, myName);
        chai.assert.equal(error.message, myMessage);
        chai.assert.equal(error.source, mySource);
        chai.assert.isTrue(error.stack && error.stack.includes("error.test.ts"));
  ...
  describe("SystemError", function () {
    it("constructor 1", () => {
      {
        const error = new SystemError(mySource, myMessage, myName, myHelpLink);
        chai.assert.equal(error.name, myName);
        chai.assert.equal(error.message, myMessage);
        chai.assert.equal(error.source, mySource);
        chai.assert.isTrue(error.stack && error.stack.includes("error.test.ts"));
    ...
    it("constructor 2", () => {
      {
        const error = new SystemError(new RangeError(myMessage), mySource);
        chai.assert.equal(error.name, "RangeError");
        chai.assert.equal(error.message, myMessage);
        chai.assert.equal(error.source, mySource);
        chai.assert.isTrue(error.stack && error.stack.includes("error.test.ts"));
      ...
      {
        const error = new SystemError(new RangeError(myMessage), mySource, myName);
        chai.assert.equal(error.name, myName);
        chai.assert.equal(error.message, myMessage);
        chai.assert.equal(error.source, mySource);
        chai.assert.isTrue(error.stack && error.stack.includes("error.test.ts"));
