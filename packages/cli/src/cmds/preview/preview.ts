...
export default class Preview extends YargsCommand {
  ...
  private async localPreview(workspaceFolder: string): Promise<Result<null, FxError>> {
    ...
    const frontendInstallStartCb = commonUtils.createNpmInstallStartCb(
      frontendInstallBar,
      constants.frontendInstallStartMessage
    );
    const frontendInstallStopCb = commonUtils.createNpmInstallStopCb(
      constants.frontendInstallTitle,
      frontendInstallBar,
    ...
    const backendInstallStartCb = commonUtils.createNpmInstallStartCb(
      backendInstallBar,
      constants.backendInstallStartMessage
    );
    const backendInstallStopCb = commonUtils.createNpmInstallStopCb(
      constants.backendInstallTitle,
      backendInstallBar,
